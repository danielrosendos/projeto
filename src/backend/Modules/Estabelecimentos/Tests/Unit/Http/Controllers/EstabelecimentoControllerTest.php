...
class EstabelecimentoControllerTest extends TestCase
{
    ...
    public function test_campo_latitude_obrigatorio()
    {
        $registerData = [
            "primeiro_nome" => "Daniel",
            "ultimo_nome" => " Rosendo",
    ...
    public function test_campo_latitude_validacao_tipo()
    {
        $registerData = [
            "primeiro_nome" => "Daniel",
            "ultimo_nome" => " Rosendo",
    ...
    public function test_campo_longitude_obrigatorio()
    {
        $registerData = [
            "primeiro_nome" => "Daniel",
            "ultimo_nome" => " Rosendo",
    ...
    public function test_campo_longitude_validacao_tipo()
    {
        $registerData = [
            "primeiro_nome" => "Daniel",
            "ultimo_nome" => " Rosendo",
